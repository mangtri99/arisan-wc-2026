    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p
            style="font-size: 28px; font-weight: 700; color: #edf2ea; margin: 0"
          >
            {{ store.pool.players.length }}
          </p>
        </div>
        <div>
          <p
        ...
        >
          ...
          <div
            ...
            :style="{
              ...
              padding: '6px 8px',
              borderRadius: '8px',
              background: championIds.includes(tid)
          ...
          >
            ...
            <span style="font-size: 14px; font-weight: 500; color: #edf2ea">{{
              TEAM_BY_ID[tid].name
            }}</span>
            <span
              style="
                ...
                color: #8da496;
              "
              >Grup {{ TEAM_BY_ID[tid].group }}</span
            >
          </div>
        </div>
      </div>
      ...
      <div
        v-if="
          store.pool.prizeMode === 'tiered' && store.pool.status === 'settled'
        "
        style="
          border: 1px solid #16352a;
          border-radius: 16px;
      ...
      >
        ...
        >
          ...
          <div style="flex: 1">
            ...
            <p
              v-if="w.teamId"
              style="font-size: 12px; color: #8da496; margin: 0"
            >
      ...
      <p
        ...
        "
      >
        🏆 Made with 🔥 by @mangtri78 x Claude
      </p>
    </div>

    <!-- ringkasan pot -->
    <div
      class="panel mb-6 flex flex-wrap items-center justify-between gap-4 p-5 sm:p-6"
    >
      <div class="flex flex-wrap gap-x-10 gap-y-3">
        <div>
          <p class="eyebrow">Total pot</p>
          <p class="tnum font-display text-3xl text-gold">
            {{ rupiah(store.pot) }}
          </p>
        </div>
        <div>
          <p class="eyebrow">Pemain</p>
          <p class="tnum font-display text-3xl text-chalk">
            {{ store.pool.players.length }}
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p class="tnum font-display text-3xl tracking-wider text-chalk-dim">
            {{ store.pool.seed }}
          </p>
        </div>
      </div>
      ...
      <div class="flex flex-col gap-6">
        ...
        <div v-if="bankTeams.length" class="panel p-5">
          <p class="eyebrow mb-3">
            🏦 Bank — {{ bankTeams.length }} negara tanpa pemilik
          </p>
